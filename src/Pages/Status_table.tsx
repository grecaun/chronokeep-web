                        ...
                        <div id="status-parent">
                            {
                                distances.map((distance, index) => {
                                    ...
                                    return (
                                        <table className="table-responsive-sm m-3" key={distance} id={distance}>
                                            { distances.length > 1 &&
                                            <thead>
                                                <tr>
                                            ...
                                            { [...Array(loops)].map((_, i) => {
                                                ...
                                                return (
                                                    <tr className={`row status-row`} key={`status${i}`}>
                                                        <th className={`col ${last_row} status-col status-${stat_map[0]}`}>{start}</th>
                                                        <th className={`col ${last_row} status-col status-${stat_map[1]}`}>{start+1}</th>
                                                        <th className={`col ${last_row} status-col status-${stat_map[2]}`}>{start+2}</th>
                                                        <th className={`col ${last_row} status-col status-${stat_map[3]}`}>{start+3}</th>
                                                        <th className={`col ${last_row} status-col status-${stat_map[4]}`}>{start+4}</th>
                                                        <th className={`col ${last_row} status-col status-${stat_map[5]}`}>{start+5}</th>
                                                        <th className={`col ${last_row} status-col status-${stat_map[6]}`}>{start+6}</th>
                                                        <th className={`col ${last_row} status-col status-${stat_map[7]}`}>{start+7}</th>
                                                        <th className={`col ${last_row} status-col status-${stat_map[8]}`}>{start+8}</th>
                                                        <th className={`col ${last_row} status-col status-last status-${stat_map[9]}`}>{start+9}</th>
                                                    </tr>
                                                )
                                            })}
                                            </tbody>
